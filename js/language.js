...
const translations = {
    'vi': {
        ...
        'nav_testimonials': 'Phản hồi học thuật',
        'nav_contact': 'Liên hệ',
        ...
        'testimonials_title': 'Phản hồi học thuật',
        'testimonial_1_text': 'BS. Hoàng Anh là cộng tác viên nghiên cứu cẩn trọng, luôn kết nối câu hỏi lâm sàng với thiết kế nghiên cứu rõ ràng và có khả năng triển khai trong môi trường đa trung tâm.',
        'testimonial_1_author': 'PGS.TS. Nguyễn Minh Quân',
        'testimonial_1_role': 'Cố vấn nghiên cứu, Bộ môn Nội',
        'testimonial_2_text': 'Trong dự án tim mạch cộng đồng, Hoàng Anh phối hợp dữ liệu rất chặt chẽ, phản hồi nhanh với nhóm thống kê và luôn giữ trọng tâm vào chất lượng phương pháp.',
        'testimonial_2_author': 'TS. Trần Thu Hà',
        'testimonial_2_role': 'Cộng tác viên dự án đa trung tâm',
        'testimonial_3_text': 'Bài trình bày của Hoàng Anh tại hội nghị đã nêu bật dữ liệu lâm sàng theo cách súc tích, minh bạch và gợi mở các hướng hợp tác nghiên cứu tiếp theo.',
        'testimonial_3_author': 'GS. Lê An',
        'testimonial_3_role': 'Ban khoa học hội nghị y học nội khoa',

        // Contact section
        'contact_title': 'Liên hệ',
        'contact_affiliation_title': 'Đơn vị công tác',
        'contact_affiliation_html': 'Bộ môn Nội, Trường Đại học Y Hà Nội<br>Đơn vị Nghiên cứu Tim mạch, Bệnh viện Đa khoa Trung ương',
        'contact_orcid_title': 'ORCID',
        'contact_email_title': 'Email bộ môn',
        'contact_profiles_title': 'Hồ sơ học thuật',
        'contact_profiles_html': '<a href="https://scholar.google.com" target="_blank" rel="noopener">Google Scholar</a> · <a href="https://www.researchgate.net" target="_blank" rel="noopener">ResearchGate</a> · <a href="https://pubmed.ncbi.nlm.nih.gov" target="_blank" rel="noopener">PubMed</a> · <a href="https://www.linkedin.com" target="_blank" rel="noopener">LinkedIn</a>',
        'contact_form_title': 'Research Collaboration Inquiry',
        'contact_form_name': 'Họ và tên',
        'contact_form_email': 'Email',
        'contact_form_phone': 'Điện thoại / tổ chức',
        'contact_form_date': 'Ngày trao đổi dự kiến',
        'contact_form_time': 'Khung thời gian',
        'contact_form_time_select': 'Chọn khung thời gian',
        'contact_form_time_morning': 'Buổi sáng (8:00 - 11:30)',
        'contact_form_time_afternoon': 'Buổi chiều (13:30 - 16:30)',
        'contact_form_reason': 'Chủ đề hợp tác / tin nhắn',
    ...
    'en': {
        ...
        'nav_testimonials': 'Academic Feedback',
        'nav_contact': 'Contact',
        ...
        'hero_btn': 'Discuss Collaboration',
        ...
        // Academic feedback section
        'testimonials_title': 'Academic Feedback',
        'testimonial_1_text': 'Dr. Hoang Anh is a careful research collaborator who connects clinical questions with clear, feasible study designs for multi-center settings.',
        'testimonial_1_author': 'Assoc. Prof. Nguyen Minh Quan',
        'testimonial_1_role': 'Research Mentor, Department of Internal Medicine',
        'testimonial_2_text': 'On the community cardiology project, Hoang Anh coordinated data rigorously, responded quickly to the statistics team, and kept the focus on methodological quality.',
        'testimonial_2_author': 'Dr. Tran Thu Ha',
        'testimonial_2_role': 'Multi-center Project Collaborator',
        'testimonial_3_text': 'Hoang Anh\'s conference presentation highlighted clinical data concisely and transparently while opening practical directions for future research collaboration.',
        'testimonial_3_author': 'Prof. Le An',
        'testimonial_3_role': 'Scientific Committee, Internal Medicine Conference',

        // Contact section
        'contact_title': 'Contact',
        'contact_affiliation_title': 'Institutional Affiliation',
        'contact_affiliation_html': 'Department of Internal Medicine, Hanoi Medical University<br>Cardiovascular Research Unit, Central General Hospital',
        'contact_orcid_title': 'ORCID',
        'contact_email_title': 'Department Email',
        'contact_profiles_title': 'Academic Profiles',
        'contact_profiles_html': '<a href="https://scholar.google.com" target="_blank" rel="noopener">Google Scholar</a> · <a href="https://www.researchgate.net" target="_blank" rel="noopener">ResearchGate</a> · <a href="https://pubmed.ncbi.nlm.nih.gov" target="_blank" rel="noopener">PubMed</a> · <a href="https://www.linkedin.com" target="_blank" rel="noopener">LinkedIn</a>',
        'contact_form_title': 'Research Collaboration Inquiry',
        'contact_form_name': 'Full Name',
        'contact_form_email': 'Email',
        'contact_form_phone': 'Phone / Institution',
        'contact_form_date': 'Preferred Discussion Date',
        'contact_form_time': 'Time Window',
        'contact_form_time_select': 'Select a time window',
        'contact_form_time_morning': 'Morning (8:00 - 11:30)',
        'contact_form_time_afternoon': 'Afternoon (13:30 - 16:30)',
        'contact_form_reason': 'Collaboration topic / message',
